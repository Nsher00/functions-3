...
// CODE HERE
const divideTwo = numbers.map((element) => element / 2)
...
// CODE HERE
const riceTotals = foods.filter(element => element.tags.includes('rice')).map((element)=> element.price).reduce((acc,cur)=> acc + cur)
console.log(riceTotals);
// THE TOTAL
//36
