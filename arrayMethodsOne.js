...
// CODE HERE
const myOrders = orders.map((element)=> element.price * (element.tax + 1))
...
// CODE HERE
const bobsTotal = purchases.filter((element)=> element.owner === 'Bob' ).map((element)=> element.price).reduce((acc,cur)=> acc + cur)
